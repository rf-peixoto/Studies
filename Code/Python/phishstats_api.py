...
if len(sys.argv) != 2:
    ...
    print("[\033[94m*\033[00m] Check \033[92mhttps://phishstats.info\033[00m for more data.")
    print("\033[00m")
    sys.exit()
...
# Reset and quit:
print("\n[\033[94m*\033[00m] Check \033[92mhttps://phishstats.info\033[00m for more data.\033[0m")
